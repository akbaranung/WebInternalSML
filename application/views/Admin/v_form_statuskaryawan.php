<div class="container">
    ...
    <div class="card-body">
        <?php echo form_open_multipart('Admin/C_statuskaryawan/tambah'); ?>
        <div class="form-group">
            <label for="judul">Status Karyawan</label>
            <input type="text" class="form-control" id="status" name="status" placeholder="Masukan Status Karyawan">
